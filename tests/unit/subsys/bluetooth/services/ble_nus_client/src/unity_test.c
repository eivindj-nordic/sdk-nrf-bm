...
uint32_t stub_sd_ble_uuid_vs_add_success(ble_uuid128_t const *p_vs_uuid, uint8_t *p_uuid_type,
					 int cmock_num_calls)
{
	*p_uuid_type = BLE_UUID_TYPE_BLE;
...
void test_ble_nus_client_tx_notif_enable_error_invalid_state(void)
{
	uint32_t nrf_err;
